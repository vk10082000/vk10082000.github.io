...
const Contactme = () => {
    ...
    const handleButtonClick = () => {
        const phoneNumber = '9908966980'; // Replace with the desired phone number
        window.location.href = `tel:${phoneNumber}`;
      };
      const emaillink = ()=>{
        window.location.href = 'mailto:vamshikrishna99089@gmail.com';
      }
            ...
            <div className='contact'>
                    ...
                    <div className="details-cards">
                        <div className="details-card red" onClick={handleButtonClick}>
                            <div>
                                ...
                                <p id="contact-phone">+91 9908966980</p>
                            </div>
                        </div>
                        ...
                        <div className="details-card green" onClick={emaillink} id="contact-email">
                            <div>
                                ...
                                <p>vamshikrishna99089@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='contact-form-div'>
                    ...
                    <div className="contact-card">
                        ...
                        <form className="contact-form" action="https://formsubmit.co/vamshikrishna99089@gmail.com" method="POST">
